    ...
    <div className="bg-white mt-4 mx-[1rem] text-black">
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            To create a new repository, Click the "+" sign in the top right
            corner
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            Then click{" "}
            <span className="text-blue-500 font-semibold">New repository</span>
          </p>
        </div>
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            ...
            <span className="font-semibold text-blue-500">
              repository name, description, choose visibility
            </span>{" "}
            and add license if desired. Note: to deploy, visibility is meant to
            be set to <span className="font-semibold">public</span>
          </p>
        </div>
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            ...
            <ul>
              ...
              <li>
                git remote add origin `repository url` (replace with the
                repository url)
              </li>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            If everything goes as planned, this should be what would show up in
            your terminal.
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          ...
          <p className="font-light">
            Refresh your page; your codes would be displayed as shown.
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          <h2 className="font-bold text-xl pb-2">
            For deploying static websites on Github:
          </h2>
          <h2 className="font-bold text-xl font-customFont2">STEP 1: </h2>
          <p className="font-light">
            Go to settings tab in the repository, scroll down to{" "}
            <span className="font-semibold text-green-500">Pages </span>{" "}
            <br></br>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          <h2 className="font-bold text-xl font-customFont2">STEP 3: </h2>
          <p className="font-light">
            If successful, this message will pop up at the top of your screen.
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          <h2 className="font-bold text-xl font-customFont2">STEP 4: </h2>
          <p className="font-light">
            Go to <span className="font-semibold text-blue-500">Actions</span>{" "}
            to check the status of your deployed website
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row mt-4">
        ...
        <div className="w-full sm:w-1/2 p-4">
          <h2 className="font-bold text-xl font-customFont2">STEP 5: </h2>
          <p className="font-light">
            Go back to pages, your site should be deployed to the URL like
