...
const Body = () => {
  return (
    <div className='bg-white mt-4 mx-[4rem] text-black'>
      ...
      <div className='flex flex-col sm:flex-row mt-4'>
        {/* Column 1: Text */}
        <div className='w-full sm:w-1/2 p-4'>
          <p>Column 1: More text content goes here.</p>
        </div>
      ...
      <div className='flex flex-col sm:flex-row mt-4'>
        {/* Column 1: Text */}
        <div className='w-full sm:w-1/2 p-4'>
          <p>Column 1: Additional text content goes here.</p>
        </div>
      ...
      <div className='flex flex-col sm:flex-row mt-4'>
        ...
        {/* Column 2: Image */}
        <div className='w-full sm:w-1/2 p-4'>
          <img src={Image5a} alt='step3' className='max-w-full h-auto' />
        </div>
      </div>
